...
exports.workflowQueue = void 0;
const logger_1 = require("../utils/logger");
const priorAuth_workflow_1 = require("../workflows/priorAuth.workflow");
const requestStoreLib = __importStar(require("./requestStore"));
/**
 ...
 * as before.
 */
const workflow = new priorAuth_workflow_1.PriorAuthWorkflow();
class InProcessQueue {
    async add(_jobName, data) {
        ...
        setImmediate(() => {
            workflow.execute(data).catch(async (err) => {
                logger_1.logger.error('[Queue] In-process job failed', { error: err.message, requestId: data.requestId });
                if (data.requestId) {
...
exports.workflowQueue = new InProcessQueue();
exports.default = exports.workflowQueue;
